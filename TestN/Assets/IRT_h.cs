...
public class IRT_h: MonoBehaviour {
	...
	//問題の認識度　a
	public static double Q1_1a=0.458;
	public static double Q1_2a=0.443;
	public static double Q2_1a=0.424;
	public static double Q2_2a=0.422;
	public static double Q3_1a=0.464;
	public static double Q3_2a=0.425;
	public static double Q4_1a=0.430;
	public static double Q4_2a=0.423;
	public static double Q5a=0.532;
	//1PLのICC計算(正答確率）
