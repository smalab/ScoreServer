...
public class IRT_e: MonoBehaviour {
	...
	void Start(){
		...
		for (double i=-5.0; i<5.5; i=i+0.1) {
			...
			Q1_3icct=1/(1+Mathf.Pow(Pi,(float)(-1*(i-Q1_3dif))));
			if(AnsQ1_e.q3 != 1){
				Q1_3icct=1-Q1_3icct;
			}
			...
			Q1_5icct=1/(1+Mathf.Pow(Pi,(float)(-1*(i-Q1_5dif))));
			if(AnsQ1_e.q5 != 1){
				Q1_5icct=1-Q1_5icct;
			}
			...
			Q1_7icct=1/(1+Mathf.Pow(Pi,(float)(-1*(i-Q1_7dif))));
			if(AnsQ2_e.q2 != 1){
				Q1_7icct=1-Q1_7icct;
			}
			...
			Q1_9icct=1/(1+Mathf.Pow(Pi,(float)(-1*(i-Q1_9dif))));
			if(AnsQ2_e.q4 != 1){
				Q1_1icct=1-Q1_1icct;
			}
